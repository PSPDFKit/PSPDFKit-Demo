...
@property (readwrite, nonatomic, strong) UIColor *hudBackgroundColor UI_APPEARANCE_SELECTOR;
@property (readwrite, nonatomic, strong) UIColor *hudForegroundColor UI_APPEARANCE_SELECTOR;
@property (readwrite, nonatomic, strong) UIColor *hudStatusShadowColor UI_APPEARANCE_SELECTOR;
@property (readwrite, nonatomic, strong) UIFont *hudFont UI_APPEARANCE_SELECTOR;
