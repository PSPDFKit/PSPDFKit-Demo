...
/**
 ...
 If not, PSPDFAnnotationBarButtonItem looks for the UIToolbar it is embedded in (you can override targetToolbarForBarButtonItem). The AnnotationToolbar will copy the style of the current UIToolbar. (barStyle, translucent, alertViewTintColor)
