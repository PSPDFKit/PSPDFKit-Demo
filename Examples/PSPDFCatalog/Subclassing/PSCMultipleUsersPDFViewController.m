...
- (void)commonInitWithDocument:(PSPDFDocument *)document {
    ...
    documentProvider.annotationParser.fileAnnotationProvider.annotationsPath = [documentProvider.document.cacheDirectory stringByAppendingPathComponent:[NSString stringWithFormat:@"annotations_%@.pspdfkit", self.currentUsername]];
    }];
}
