//
//  PSCCustomButtonAnnotationToolbarButtonsExample.m
//  PSPDFCatalog
//
...
@interface PSCCustomButtonAnnotationToolbarButtonsExample : PSCExample @end
@interface PSCCustomButtonAnnotationToolbar : PSPDFAnnotationToolbar @end
