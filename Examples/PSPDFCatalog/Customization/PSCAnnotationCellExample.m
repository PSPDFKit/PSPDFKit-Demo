...
@interface PSCAnnotationToolbar : PSPDFAnnotationToolbar @end
@interface PSCCustomAnnotationStateManager : PSPDFAnnotationStateManager @end

@interface PSCAnnotationCellExample : PSCExample @end
...
+ (CGFloat)heightForAnnotation:(PSPDFAnnotation *)annotation constrainedToSize:(CGSize)constrainedToSize {
    ...
    BOOL isShared = [PSCAnnotationTableViewController isAnnotationShared:annotation];
...
- (void)updateShareButton {
    BOOL isShared = [PSCAnnotationTableViewController isAnnotationShared:self.annotation];
